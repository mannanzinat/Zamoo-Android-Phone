...
import com.zamoo.live.adapters.LiveTvAdapter2;
import com.zamoo.live.adapters.SearchAdapter;
import com.zamoo.live.network.RetrofitClient;
import com.zamoo.live.network.apis.SearchApi;
...
public class SearchActivity extends AppCompatActivity implements SearchAdapter.OnItemClickListener {
    ...
    public void getSearchData() {
        ...
        Call<SearchModel> call = searchApi.getSearchData(Config.API_KEY, query, type, range);
