...
import com.zamoo.live.adapters.ActiveSubscriptionAdapter;
import com.zamoo.live.adapters.InactiveSubscriptionAdapter;
...
import com.zamoo.live.network.model.ActiveSubscription;
...
public class SubscriptionActivity extends AppCompatActivity implements ActiveSubscriptionAdapter.OnItemClickLiestener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userId = pref.getString(Constants.USER_ID, null);
    ...
    private void getActivePlanData() {
        Retrofit retrofit = RetrofitClient.getRetrofitInstance();
        SubscriptionApi api = retrofit.create(SubscriptionApi.class);
        Call<ActiveStatus> call = api.getActiveStatus(Config.API_KEY, userId);
        call.enqueue(new Callback<ActiveStatus>() {
            ...
            public void onResponse(Call<ActiveStatus> call, Response<ActiveStatus> response) {
                if (response.code() == 200){
                    ...
                    activeEmail.setText(userEmail);
                    activeActivePlan.setText(response.body().getPackageTitle());
                    activeExpireDate.setText(response.body().getExpireDate());
    ...
    private void updateActiveStatus() {
        ...
        editor.putString(Constants.SUBSCRIPTION_STATUS, "inactive");
        editor.apply();
    }
}
