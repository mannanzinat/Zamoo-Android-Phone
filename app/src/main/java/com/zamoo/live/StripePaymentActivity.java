...
public class StripePaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        secretKey = pref.getString("stripeSecretKey", null);
        publisherKey = pref.getString("stripePublishableKey", null);
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.code() == 200) {
                    ...
                    new ToastMsg(StripePaymentActivity.this).toastIconError("Something went wrong.");
                }
            }
