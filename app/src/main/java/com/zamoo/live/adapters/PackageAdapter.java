...
public class PackageAdapter extends RecyclerView.Adapter<PackageAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (pac != null) {
            ...
            //holder.priceTv.setText(pac.getPrice() + " "+ currency);
            //holder.packageNameTv.setText(" - "+pac.getName());
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            /*buyNowTv = itemView.findViewById(R.id.buy_now_tv);
            priceTv = itemView.findViewById(R.id.price_tv);
            packageNameTv = itemView.findViewById(R.id.package_name_tv);
            packageDesTv = itemView.findViewById(R.id.package_description_tv);
            packageLayout = itemView.findViewById(R.id.package_layout);*/
